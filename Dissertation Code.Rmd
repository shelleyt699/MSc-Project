...
exp(forecast_mod_1_hanover$mean[1])
exp(forecast_mod_1_hanover$lower[1,])
exp(forecast_mod_1_hanover$upper[1,])
-exp(forecast_mod_1_hanover$mean[1])+exp(cases_test_hanover[1])

exp(forecast_mod_1_hanover$mean[7])
exp(forecast_mod_1_hanover$lower[7,])
exp(forecast_mod_1_hanover$upper[7,])
-exp(forecast_mod_1_hanover$mean[7])+exp(cases_test_hanover[7])

exp(forecast_mod_1_hanover$mean[14])
exp(forecast_mod_1_hanover$lower[14,])
exp(forecast_mod_1_hanover$upper[14,])
-exp(forecast_mod_1_hanover$mean[14])+exp(cases_test_hanover[14])
